...
from IDSAnoShift import utils, data
...
def t_data():
    traffic_data = [
        ["c041","other","c263","c363","0","0.0","0.0","0.41","0","0","0.0","0.0","0.0","SF", "1"],
        ["c041","other","c263","c363","0","0.1","0.0","0.41","0","0","0.0","0.0","0.0","SF", "-1"],
        ["c041","other","c263","c363","0","0.2","0.0","0.41","0","0","0.0","0.0","0.0","SF", "-1"],
        ["c041","other","c263","c363","0","0.3","0.0","0.41","0","0","0.0","0.0","0.0","SF", "1"],
        ["c041","other","c263","c363","0","0.0","0.0","0.41","0","0","0.0","0.0","0.0","SF", "1"],
        ["c041","other","c263","c363","0","0.1","0.0","0.41","0","0","0.0","0.0","0.0","SF", "-1"],
        ["c041","other","c263","c363","0","0.2","0.0","0.41","0","0","0.0","0.0","0.0","SF", "-1"],
        ["c041","other","c263","c363","0","0.3","0.0","0.41","0","0","0.0","0.0","0.0","SF", "1"],
